...
@RestController
@RequestMapping("/api/triad-j-kafka")
public class TriadJKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TriadJKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TriadJKafkaResource(KafkaProperties kafkaProperties) {
